...
public class Level3 extends EnigmeArea {
    ...
    public boolean begin(Window window, FileSystem fileSystem) {
        ...
        levers[0] = new Lever(this, Orientation.DOWN, new DiscreteCoordinates(10, 5));
        levers[1] = new Lever(this, Orientation.DOWN, new DiscreteCoordinates(9, 5));
        levers[2] = new Lever(this, Orientation.DOWN, new DiscreteCoordinates(8, 5));
